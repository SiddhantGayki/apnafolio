...
//   // 🔥 Auto Save Draft (ignore file objects)
//   // useEffect(() => {
//   //   const cleanedData = JSON.parse(JSON.stringify(formData));
//   //   delete cleanedData.resumeFile;

//   //   localStorage.setItem(DRAFT_KEY, JSON.stringify(cleanedData));
//   // }, [formData]);

//   useEffect(() => {
//   const cleanedData = JSON.parse(JSON.stringify(formData));

//   // Remove file objects from draft
//   cleanedData.resumeFile = null;
//   if (cleanedData.contact) cleanedData.contact.photo = null;
...
//       ) {
//         alert("Only PDF or Word allowed");
//         return;
//       }
//     }
...
//               aspect={1}
//               onCropChange={setCrop}
//               onZoomChange={(e) => setZoom(Number(e))}
...
//                   alert("Cropped image still too large");
//                   return;
//                 }
