...
export default function ResumeForm({ onSubmit = () => {} }) {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      onSubmit(formData);
      console.log("🔥 ResumeForm submitting:", formData);
...
// export default function ResumeForm({ onSubmit = () => {}, initialData = null }) {
...
//     if (name === "resumeFile") {
//       setFormData({ ...formData, resumeFile: files?.[0] || null });
//       return;
//     }
...
//       <h3>Contact</h3>
//       <input name="contact.email" value={formData.contact.email} onChange={handleChange} placeholder="Email" />
//       <input name="contact.phone" value={formData.contact.phone} onChange={handleChange} placeholder="Phone" />
//       <input name="contact.location" value={formData.contact.location} onChange={handleChange} placeholder="Location" />
//       <input name="contact.github" value={formData.contact.github} onChange={handleChange} placeholder="GitHub" />
//       <input name="contact.linkedin" value={formData.contact.linkedin} onChange={handleChange} placeholder="LinkedIn" />
//       <input name="contact.website" value={formData.contact.website} onChange={handleChange} placeholder="Website" />

//       <label>Profile Photo (optional)</label>
//       <input type="file" accept="image/*" onChange={(e) => handleChange(e, null, null, null)} name="contact.photo" />
//       {formData.contact.photoUrl && <small>✅ Photo already uploaded</small>}

//       <label>Resume (optional)</label>
//       <input type="file" accept=".pdf,.doc,.docx" name="resumeFile" onChange={handleChange} />
//       {formData.resumeFileUrl && <small>✅ Resume already uploaded</small>}
