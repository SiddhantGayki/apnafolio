...
//       .catch(() => alert("Not admin"))
//       .finally(() => setLoading(false));
//   }, []);

//   const updateUser = (email, paid, selectedTemplate) => {
//     api.post("/admin/update-user", { email, paid, selectedTemplate }, { headers: { Authorization: `Bearer ${token}` } })
//       .then(() => alert("Updated"))
...
//         <table>
//           <thead>
//             <tr><th>Email</th><th>Paid</th><th>Template</th><th>Actions</th></tr>
//           </thead>
//           <tbody>
//             {users.map(u => (
//               <tr key={u._id}>
//                 <td>{u.email}</td>
//                 <td>{u.paid ? "✅" : "❌"}</td>
//                 <td>{u.selectedTemplate || "-"}</td>
//                 <td>
//                   <button onClick={() => updateUser(u.email, true, "template1")}>Grant Free T1</button>
//                 </td>
//               </tr>
//             ))}
//           </tbody>
