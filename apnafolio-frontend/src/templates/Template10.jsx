  ...
  return (
    <div className={`t1-container ${theme}`}>
      ...
      <section id="hero" className="t1-hero">
        ...
        />
        <motion.h1 className="gradient-text">{d.name}</motion.h1>
        <motion.h2>{d.role}</motion.h2>
        <p>{d.summary}</p>
      </section>

      {/* About */}
      <section id="about" className="t1-section">
        <h3>About Me</h3>
        <p>{d.summary}</p>
      </section>

      {/* Skills */}
      <section id="skills" className="t1-section">
        <h3>Skills</h3>
        {subcats.map(sc => {
          const arr = d[sc.key] || [];
            ...
            <div key={sc.key} className="skills-subcat">
              ...
              <div className="t1-skill-grid">
                {arr.map((s, i) => {
                  ...
                  return (
                    <motion.div key={i} className="t1-skill" whileHover={{ scale: 1.08 }}>
      ...
      {/* Projects */}
      <section id="projects" className="t1-section">
        <h3>Projects</h3>
        <div className="t1-projects">
          {(d.projects || []).map((p,i)=>(
            <div key={i} className="t1-project-card">
      ...
      {/* Education */}
      <section id="education" className="t1-section">
        <h3>Education</h3>
      ...
      {/* Experience */}
      {!!(d.experience || []).length && (
        <section id="experience" className="t1-section">
          <h3>Experience</h3>
      ...
      {!!(d.certifications || []).length && (
        <section id="certifications" className="t1-section">
      ...
      {/* Resume */}
      <section id="resume" className="t1-section">
        <h3>Resume</h3>
        {d.resumeFile ? (
          <a
