    ...
    <div className="tpl4-premium">
        ...
        <div className="hero-inner glass">
          ...
          <div className="hero-meta">
            ...
            <div className="hero-ctas">
              {d.resumeFile && (
                <a className="btn primary" href={d.resumeFile} download>
                  Download Resume
                </a>
              )}
              {d.projects?.length > 0 && (
      ...
      <section id="about" className="tpl4-section">
        <div className="section-inner">
          <h2>About Me</h2>
          <p>{d.summary || "Write about yourself…"}</p>
        </div>
      </section>
                ...
                <article key={i} className="proj-card">
                  ...
                  <div className="proj-body">
                    ...
                    <div className="proj-actions">
                      ...
                      {p.document && (
                        <a href={p.document} className="small-btn" download>
                          Doc
                        </a>
                      )}
                    </div>
      ...
      {/* EDUCATION */}
      <section id="education" className="tpl4-section alt">
        <div className="section-inner">
          <h2>Education</h2>
              ...
              {d.experience.map((ex, i) => (
                <div key={i} className="timeline-item">
                  ...
                  <div className="ti-right">
                    ...
                    {ex.document && (
                      <a href={ex.document} download className="proof">
                        Proof
                      </a>
                    )}
                  </div>
            ...
            <div className="cert-grid">
              {d.certifications.map((c, i) => (
                <div key={i} className="cert-card">
                  ...
                  {c.document && (
                    <a className="cert-proof" href={c.document} download>
                      View
                    </a>
                  )}
                </div>
      ...
      {d.resumeFile && (
        <section id="resume" className="tpl4-section">
          <div className="section-inner">
            <h2>Resume</h2>
            <a className="btn primary large" href={d.resumeFile} download>
              Download Resume
            </a>
          </div>
        </section>
          ...
          <div className="contact-form glass">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="form-actions">
                ...
                {d.contact?.email && (
                  <a className="btn ghost" href={`mailto:${d.contact.email}`}>
