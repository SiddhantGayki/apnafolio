...
export default function Template8({ data }) {
  ...
  <meta property="og:image" content={data?.contact?.photo || "/default-avatar.png"} />
      ...
      <section id="hero" className="t2-hero">
        ...
        <svg className="curve-divider" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 150">
          <path fill="var(--bg)" d="M0,64L80,69.3C160,75,320,85,480,101.3C640,117,800,139,960,144C1120,149,1280,139,1360,133.3L1440,128V0H0Z"/>
        </svg>
      </section>
      ...
      <section id="resume" className="t2-section alt">
        <h3>Resume</h3>
        {data?.resumeFile ? (
          <a href={data.resumeFile} download className="t2-btn">Download Resume</a>
